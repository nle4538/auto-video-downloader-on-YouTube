...
![YouTube API](https://img.shields.io/badge/YouTube%20API-v3-red?logo=youtube)
![License](https://img.shields.io/badge/License-MIT-green)
![Status](https://img.shields.io/badge/Status-Stable-brightgreen)

**Автоматизированная система пакетной загрузки видео на YouTube с отложенной публикацией**

[Начало работы](#-быстрый-старт) • [Документация](#-документация) • [Примеры](#-примеры-конфигурации) • [FAQ](#-troubleshooting)
...
### 🎯 Основные функции
- ✅ **Пакетная загрузка** — до 15 видео за раз
- ✅ **Отложенная публикация** — точное расписание выхода
- ✅ **Автоматизация** — без ручного вмешательства
- ✅ **Многоканальность** — разные токены для разных каналов
